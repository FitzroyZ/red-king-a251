...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/red-king-a251#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/red-king-a251
```

A live public deployment of this template is available at [https://red-king-a251.templates.workers.dev](https://red-king-a251.templates.workers.dev)
